...
const reply_markup = {
  ...
  inline_keyboard: [
    [
      ...
      { text: "🛒 Deals Channel", url: "https://t.me/alootdeals" },
    ],
    [
      { text: "🔃 Updates", url: "https://t.me/aprojects" },
      { text: "💁‍♂️ Support", url: "https://t.me/asupportchat" },
    ],
  ],
};
...
setInterval(track, 2700000); //Track every hr.
